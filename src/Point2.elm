...
inverse : Point2 Float -> Point2 Float
inverse point =
...
clamp : Point2 number -> Point2 number -> Point2 number -> Point2 number
clamp min max value =
    { x = Basics.clamp min.x max.x value.x, y = Basics.clamp min.y max.y value.y }
